  ...
  const fetchRestaurantData = async () => {
    try {
      ...
      if (restaurantData && restaurantData.id) {
        ...
        const ordersResponse = await orderAPI.getRestaurantOrders(
          restaurantData.id
        );
      ...
      if (
        ...
        error.response.data.message == "Restaurant not found for this user"
      ) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!restaurant ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              You need to create a restaurant first to access the dashboard.
            </p>
            <button
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-primary-700 mb-4">
                      You haven't added any food items yet. Let's get your menu
                      set up!
                    </p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      ...
                      {restaurant.contactInformation?.email || "N/A"}
                    </p>
                    <p>
                      <span className="text-gray-600">Phone:</span>{" "}
                      {restaurant.contactInformation?.mobile || "N/A"}
                    </p>
                    <p>

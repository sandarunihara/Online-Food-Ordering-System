...
import { ChefHat, MapPin, Phone, Mail, Facebook, Twitter, Instagram } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Your favorite food delivery app. We bring delicious meals from the best restaurants 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@foodx.com</span>
              </li>
            </ul>
          </div>
        </div>
